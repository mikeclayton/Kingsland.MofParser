...
internal static partial class ParserEngine
{
    ...
    ///
    /// </remarks>
    private static PropertyDeclarationAst ParsePropertyDeclarationAst(TokenStream stream, QualifierListAst qualifierList, ParserQuirks quirks = ParserQuirks.None)
    {
